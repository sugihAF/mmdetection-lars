...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_prefix=dict(
            img='lars_v1.0.0_images/train/images/', seg='lars_v1.0.0_annotations/train/panoptic_masks/'),
...
val_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_prefix=dict(img='lars_v1.0.0_images/val/images/', seg='lars_v1.0.0_annotations/val/panoptic_masks/'),
        test_mode=True,
